...
svg = {
  ...
  // Intro
  eyes: `<div><svg width=999 height=999 xmlns='http://www.w3.org/2000/svg' id=eyesvg><path d="M0 0L980 0L980 980L0 980L0 0M440 500C400 440 250 440 200 500C280 540 350 540 440 500M800 500C740 440 630 440 550 500C630 540 710 540 800 500" fill="#000" stroke="#000"/></svg></div>`,
